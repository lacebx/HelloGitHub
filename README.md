...
It's nothing flashy. It prints "Hello GitHub!" and counts numbers. But what matters here is the *structure*: a `.h` header declaring functions, a `Functions.cpp` implementing them, and a clean `main` calling them. That's real software organization. That's the stuff that carries over to every language and every project.

> *Birarenze* — the simplest programs teach the most important habits.
